...
// Test Cases to test creating service request and form actions
describe("Testing Create and List Request Functionality -> 312 App", () => {
  test("(5 pts) Create a service request and see if appears on list request page", async () => {
    ...
    // Check Initially if the default service request are present
    ...
    expect(
      document.getElementById("main-table-body").innerHTML.includes("Chris") &&
        document
          ...
          .innerHTML.includes("Tejas") &&
        document.getElementById("main-table-body").innerHTML.includes("Tired")
    );
  ...
  test("(5 pts) Create a service request and see if appears on list request page and click reset button", async () => {
    let iname = "Some Name";
